...
exports.add = async (req, res, next) => {
    ...
    try {
        ...
        return res.status(201).redirect('/exportClients');
    }
    catch (e) {
        console.error(e);
...
exports.index = async (req, res, next) => {
    ...
    return req.api ?
        ...
        : res.render('exportClients/index', {
            count: data.count,
            data: data.rows,
            user: req.userInfo
        });
...
exports.detail = async (req, res, next) => {
    ...
    if (data) return res.render('exportClients/detail', {
...
exports.delete = async (req, res, next) => {
    ...
    if (result) return res.redirect('/exportClients');
    else res.status(400).json(`fail id:${id}`)
}
