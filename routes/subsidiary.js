...
const materialController = require('../controllers/subsidiary');
const jwt = require('../services/jwt')

/* GET material listing. */
router
  .get('/', jwt.verifyToken, materialController.index)
  .get('/add', jwt.verifyToken, (req, res, next) => res.json('subsidiary/add'))
  .post('/add', jwt.verifyToken, materialController.add)
  .get('/edit/:id', jwt.verifyToken, (req, res, next) => res.json('subsidiary/edit'))
